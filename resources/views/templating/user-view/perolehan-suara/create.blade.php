            ...
            <div class="row mb-3">
                ...
                @foreach ($candidates as $item)
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden" name="id_candidate[]" required readonly value="{{ $item->candidate_encrypted_id }}">
            ...
            <div class="row mb-3">
                ...
                @foreach ($parties as $item)
                    <div class="col-md-4 mb-3">
                        <label for="total_vote_vote_count" class="col-form-label"> {{ $loop->index+1 }}. {{ $item->party_name }} ({{ $item->party_acronym }})</label>
