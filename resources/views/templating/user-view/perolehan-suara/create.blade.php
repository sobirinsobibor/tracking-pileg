...
@section('main-content')
    <div class="card">
        <div class="card-body">
            ...
            <h5 class="card-title fw-light text-capitalize  mb-4">{{ $voting_places->voting_place_sub_district }},
                {{ $voting_places->voting_place_district }}, {{ $voting_places->voting_place_city }},
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="number" name="candidate_vote_vote_count[]" class="form-control"
                                    id="candidate_vote_vote_count" required>
                            </div>
                        </div>
                    @endforeach
                    ...
                    @foreach ($parties as $item)
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="total_vote_vote_count"
                                name="total_vote_vote_count[]" required>
                        </div>
                    @endforeach
                </div>
                <div class="row">
